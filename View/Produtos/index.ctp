<div class="produtos index">
	...
	<tr>
			<th><?php echo $this->Paginator->sort('id_produto'); ?></th>
	...
	<tr>
		<td><?php echo h($produto['Produto']['id_produto']); ?>&nbsp;</td>
		<td><?php echo h($produto['Produto']['title']); ?>&nbsp;</td>
		<td><?php echo h($produto['Produto']['description']); ?>&nbsp;</td>
		<td class="actions">
